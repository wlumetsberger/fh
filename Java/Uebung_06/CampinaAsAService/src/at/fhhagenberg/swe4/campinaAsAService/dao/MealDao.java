...
public class MealDao implements Dao<Meal>{
	...
	public List<Meal> findAll() {
		...
		retVal.add(new Meal(1, "Schnitzel", "Schnitzel vom Schwein", catDao.findAll().get(0), LocalDateTime.now(), LocalDateTime.now(), 15.00));
		retVal.add( new Meal(1, "Gschnetzlts", "Gschnetzlts vom Schwein", catDao.findAll().get(0), LocalDateTime.now(), LocalDateTime.now(),10.90));
		return retVal;
	}
